...
public class Ashaworkeraddhomeinspectiondetails extends AppCompatActivity implements JsonResponse {
    EditText e1;
    String details;
    ListView l1;
    ImageButton i1;
    Button b1;
    String[] name, detailss, file, statuss, value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ashaworkeraddhomeinspectiondetails);
        ...
        JR1.json_response = (JsonResponse) Ashaworkeraddhomeinspectiondetails.this;
        String q1 = "/ashaworkerviewinspection?lid=" + sh.getString("log_id", "");
        q1 = q1.replace(" ", "%20");
        JR1.execute(q1);
...
//	        	rid=View_waste_disposal_request.report_id;
            ...
            String q = "http://" + Ipsettings.text + "/api/ashaworker_addinspectionreport";
...
//                    aa.put("tid",types_id.getBytes());
            ...
            fua.json_response = (JsonResponse) Ashaworkeraddhomeinspectiondetails.this;
            fua.execute(aa);
        } catch (Exception e) {
    ...
    private void selectImageOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Ashaworkeraddhomeinspectiondetails.this);
...
//                sendAttach1();
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("ashaworker_addinspectionreport")) {
                ...
                if (status.equalsIgnoreCase("success")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), Ashaworkeraddhomeinspectiondetails.class));
            ...
            else if(method.equalsIgnoreCase("ashaworkerviewinspection"))
            {
                String status=jo.getString("status");
                Log.d("pearl",status);
...
//                    aid=new String[ja1.length()];
                    ...
                    detailss=new String[ja1.length()];
                    ...
                    for(int i = 0;i<ja1.length();i++)
                    {
                        ...
                        detailss[i]=ja1.getJSONObject(i).getString("details");
...
////                    l1.setAdapter(ar);
                    Custtimage cc=new Custtimage(this,file,name,statuss,detailss);
                    l1.setAdapter(cc);
                }
            }
